...
@Component({
  selector: 'app-timesheet-l2',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './timesheet-l2.component.html',
  styleUrls: ['./timesheet-l2.component.css']
})
export class TimesheetL2Component implements OnInit {
