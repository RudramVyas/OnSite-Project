...
@Component({
  selector: 'app-timesheet-laborer',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './timesheet-laborer.component.html',
  styleUrls: ['./timesheet-laborer.component.css']
})
export class TimesheetLaborerComponent implements OnInit {
